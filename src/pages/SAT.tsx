...
const universalGrammarReels: ReelItem[] = [
  { title: "Clauses", description: "What makes up a sentence?", duration: "0:27", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZYGEKXgrwr/" } },
  { title: "Boundaries", description: "Know exactly what the SAT and ACT tests.", duration: "0:37", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZYNunAgJkJ/" } },
  { title: "Boundary Errors", description: "Traps and Tricks the SAT and ACT always try to pull.", duration: "0:28", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZY7sVTsUEY/" } },
  { title: "PUNCTUATION: Semicolons & Periods", description: "What makes a sentence done?", duration: "0:33", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZaQsweRXj6/" } },
  { title: "PUNCTUATION: Colons", description: "The easiest punctuation on the SAT and ACT.", duration: "0:29", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZaW-lBRdKU/" } },
  { title: "PUNCTATION: Dashes", description: "You never use these, but the SAT and ACT LOVE them.", duration: "0:37", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZbJ51KMSWD/" } },
  { title: "FANBOYS", description: "Is that Drake?", duration: "0:28", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZcuf5hxVlC/" } },
  { title: "Subordinating Conjunctions", description: "The ultimate TRICK the SAT and ACT pull that's really easy to see through.", duration: "0:41", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZdVr_CgTkS/" } },
  { title: "PUNCTUATION: Commas", description: "A rapid-fire overview of when to use and not use commas.", duration: "0:21", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZdaMnags6s/" } },
  { title: "Appositives", description: "Michael Jackson can help you with a rare rule for the SAT and ACT.", duration: "0:56", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZd6QcNMK7z/" } },
  { title: "Modifiers", description: "What sounds right isn't always right.", duration: "0:42", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZeD6Mds-AK/" } },
  { title: "Agreement", description: "THE ULTIMATE GRAMMAR TRICK STOPPING YOU FROM A 1600!", duration: "0:60", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZfbAT4xzJn/" } },
  { title: "Possession", description: "Who owns what and why?", duration: "0:60", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZfjG3pRmOw/" } },
  { title: "Consistency", description: "Learn what the SAT and ACT love and hate to see.", duration: "0:42", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZf-rr_ABqm/" } },
  { title: "Parallelism", description: "Another rare rule that keeps people from breaking past the 600s.", duration: "0:27", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZgVotQMCP2/" } },
  { title: "Logic", description: "What makes a sentence make sense?", duration: "0:41", socialLinks: { instagram: "https://www.instagram.com/akaashacademy/reel/DZgdX8YsPmE/" } },
];
    ...
    <div className="bg-black text-white">
      ...
      <section id="grammar" className="px-6 md:px-16 py-24 scroll-mt-20 border-b border-white/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
          {universalGrammarReels.map((reel, idx) => (
